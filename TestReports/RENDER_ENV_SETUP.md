...
**說明**：連接到 Supabase PostgreSQL 資料庫（使用 ADO.NET 格式，包含 SSL 設定）
...
- [x] `ConnectionStrings__DefaultConnection` = `Host=db.idyfbtswixhfahddnlkw...`
- [x] `Jwt__Key` = `YourSuperSecretKeyForJwtToken...`
...
- ✅ JWT Key 已產生：`YourSuperSecretKeyForJwtTokenGeneration2026!MustBeLongEnough`
- 🔒 請勿將此密鑰公開分享
- 🔒 建議定期更換（每 3-6 個月）
